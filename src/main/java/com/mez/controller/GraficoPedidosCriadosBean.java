...
import com.mez.security.UsuarioLogado;
import com.mez.security.UsuarioSistema;
...
public class GraficoPedidosCriadosBean {
	...
	private void adicionarSerie(String rotulo, Usuario criadoPor) {
		Map<Date, BigDecimal> valoresPorData = this.pedidos.valoresTotaisPorData(8, criadoPor);
